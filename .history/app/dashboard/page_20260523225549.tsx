...
export default function ProviderDashboard() {
  ...
  const handleAcceptLead = async (leadId: string) => {
    ...
    try {
      ...
      console.log('[v0] Accepting lead:', leadId);
      ...
      console.error('[v0] Failed to accept lead:', err);
  ...
  const handleMarkComplete = async (leadId: string) => {
    try {
      setActionLoading(leadId);
      console.log('[v0] Marking lead as completed:', leadId);
      ...
      console.log('[v0] Lead marked as completed');
